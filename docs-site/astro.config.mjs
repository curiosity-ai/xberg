  ...
  integrations : [
    starlight(
        xbergStarlightConfig({
          ...
          editBaseUrl :
              "https://github.com/xberg-io/xberg/edit/main/docs-site/",
          plugins : [
            starlightLlmsTxt({
              customSets : [
                {
                ...
                },
                {
                  label : "Concepts",
                  description :
                      "Architecture, the extraction pipeline, and the plugin system.",
                  paths : [ "concepts/**", "features" ],
                },
                {
                  label : "Integrations",
                  description :
                      "Connecting Xberg to Open WebUI, SurrealDB, and other tools.",
                  paths : [ "integrations/**" ],
                },
                {
                  label : "Reference",
                  description :
                      "Per-language API docs, configuration schema, types, errors, formats, and CLI/MCP " +
                          "reference.",
                  paths : [ "reference/**" ],
                },
                {
                  label : "More",
                  description :
                      "Migration, changelog, contributing, and ecosystem.",
                  paths : [
                    "migration/**", "changelog", "contributing", "ecosystem"
                  ],
                },
              ],
              optionalLinks : [
