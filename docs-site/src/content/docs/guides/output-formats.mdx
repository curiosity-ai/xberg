...
- **Content Format** — `output_format` controls the `content` field: Plain, Markdown, Djot, HTML, JSON, Structured, [DocTags](/guides/doctags-output/), [DOT](/guides/diagram-dot-output/), or a custom renderer
