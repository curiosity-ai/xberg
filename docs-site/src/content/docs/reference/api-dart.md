...
```dart
DoctorReport doctor(ExtractionConfig config)
```
...
```dart
bool installPdfRenderDiagnostics()
```

**Example:**

```dart
final result = installPdfRenderDiagnostics();
```
...
```dart
List<ProcessingWarning> takePdfOxideRenderWarnings()
```

**Example:**

```dart
final result = takePdfOxideRenderWarnings();
```
...
```dart
List<int> buildDecoderPromptTokens(int startOfTranscript, int langId, int transcribe, int noTimestamps, bool timestamps)
```

**Example:**

```dart
final result = buildDecoderPromptTokens(42, 42, 42, 42, true);
```
...
```dart
int timestampTokenToMs(int tokenId, int timestampBeginId)
```

**Example:**

```dart
final result = timestampTokenToMs(42, 42);
```
...
```dart
static DoctorCheck pass(String name, String message)
```

**Example:**

```dart
final result = DoctorCheck.pass("value", "value");
```
...
```dart
static DoctorCheck warn(String name, String message)
```

**Example:**

```dart
final result = DoctorCheck.warn("value", "value");
```
...
```dart
static DoctorCheck fail(String name, String message)
```

**Example:**

```dart
final result = DoctorCheck.fail("value", "value");
```
...
```dart
static DoctorCheck skip(String name, String message)
```

**Example:**

```dart
final result = DoctorCheck.skip("value", "value");
```
