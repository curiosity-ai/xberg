...
| `chunk_breadcrumb_target` | `--chunk-breadcrumb-target` | `Option<BreadcrumbTargetArg>` |  | Where the heading-path breadcrumb is written when Markdown chunking prepends heading context (content, metadata, or both). Default: content. |
