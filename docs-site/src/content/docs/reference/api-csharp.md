...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `StartOfTranscript` | `uint` | Yes | The start of transcript |
| `LangId` | `uint` | Yes | The lang id |
| `Transcribe` | `uint` | Yes | The transcribe |
| `NoTimestamps` | `uint` | Yes | The no timestamps |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `TokenId` | `uint` | Yes | The token id |
| `TimestampBeginId` | `uint` | Yes | The timestamp begin id |
...
```csharp
public DoctorCheck Pass(string name, string message)
```
...
```csharp
public DoctorCheck Warn(string name, string message)
```
...
```csharp
public DoctorCheck Fail(string name, string message)
```
...
```csharp
public DoctorCheck Skip(string name, string message)
```
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `MaxEntries` | `nuint?` | `null` | Maximum number of cached entries. |
...
| `DetLimitSideLen` | `uint` | — | Maximum side length for detection image (default: 1024) Larger images may be resized to this limit for faster inference |
