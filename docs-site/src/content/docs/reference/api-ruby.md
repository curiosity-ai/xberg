...
<!-- alef:hash:ad56380221e2ebf02b67572ce989a433e3f133247274ed00d2ebe63db8a35448 -->
...
| `device` | `CandleDevicePreference?` | `:auto` | Optional per-call device override. |
...
| `ocr_strategy` | `OcrStrategy?` | `:auto` | Override the OCR page-selection strategy for this file. |
...
| `result_format` | `ResultFormat?` | `:unified` | Override result format for this file. |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `task` | `GlmOcrTaskKind?` | `:ocr` | Optional recognition task; the backend constructor's task is used when absent. |
| `device` | `CandleDevicePreference?` | `:auto` | Optional per-call device override. |
| `layout_mode` | `GlmOcrLayoutMode?` | `:whole_page` | Optional whole-page or layout-paired dispatch mode. |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `task` | `PaddleOcrVlTaskKind?` | `:ocr` | Optional per-call recognition task; the backend constructor's task is used when absent. |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `variant` | `CandleTrocrVariant?` | `:base_printed` | Optional model variant; the backend constructor's variant is used when absent. |
| `device` | `CandleDevicePreference?` | `:auto` | Optional per-call device override. |
| `cache_dir` | `String?` | `nil` | Optional Hugging Face cache root. |
| `hf_revision` | `String?` | `nil` | Optional immutable Hugging Face model revision. |
