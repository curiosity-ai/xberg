...
```swift
public static func installPdfRenderDiagnostics() -> Bool
```

**Example:**

```swift
let result = installPdfRenderDiagnostics()
```
...
```swift
public static func buildDecoderPromptTokens(startOfTranscript: UInt32, langId: UInt32, transcribe: UInt32, noTimestamps: UInt32, timestamps: Bool) -> [Int64]
```

**Example:**

```swift
let result = buildDecoderPromptTokens(42, 42, 42, 42, true)
```
...
```swift
public static func timestampTokenToMs(tokenId: UInt32, timestampBeginId: UInt32) -> UInt32
```

**Example:**

```swift
let result = timestampTokenToMs(42, 42)
```
...
```swift
public static func pass(name: String, message: String) -> DoctorCheck
```
...
```swift
public static func warn(name: String, message: String) -> DoctorCheck
```
...
```swift
public static func fail(name: String, message: String) -> DoctorCheck
```
...
```swift
public static func skip(name: String, message: String) -> DoctorCheck
```
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `maxEntries` | `UInt64?` | `null` | Maximum number of cached entries. |
