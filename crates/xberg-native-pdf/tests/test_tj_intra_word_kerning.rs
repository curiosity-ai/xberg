//! Synthetic minimal reproducer for in-TJ-array kerning.
//!
...
//!
//! The real-world manifestation of this defect (split-words like "diffe rent",
...
fn kerning_pdf() -> Vec<u8> {
    ...
    // each failure mode independently. ~keep
    let content = "\
...
#[test]
#[ignore = "synthetic single-TJ-array case — see module docs; the real-world \
            split-word cases are covered by the should_insert_space guard"]
