...
//! must still extract in left-to-right reading order.
//!
...
/// The exact reported reproduction: `"Hello"`, 3.5pt amplitude,
/// period 6 sinusoidal Y-jitter. Must extract in reading order.
#[test]
fn glyph_jitter_word_placeholder_reading_order() {
...
#[test]
fn glyph_jitter_max_amplitude_reading_order() {
...
#[test]
fn genuine_line_break_still_splits_not_overmerged() {
