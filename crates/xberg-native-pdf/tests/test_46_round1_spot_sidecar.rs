//! Round-1 probes for the composite-then-separate SMask path in
...
pub const HONEST_GAP_NONSEP_DEVICEN_GROUP: &str = "HONEST_GAP_NONSEP_DEVICEN_GROUP: ISO 32000-1 §11.3.4 + §11.6.6 \
...
/// dispatch path.
pub const HONEST_GAP_NONSEP_K_CHANNEL_FOR_NON_CMYK_FOUR_COMPONENT_ICC: &str = "HONEST_GAP_NONSEP_K_CHANNEL_FOR_NON_CMYK_FOUR_COMPONENT_ICC: \
...
fn round1_c1_blend_mode_classification_matches_spec() {
    ...
    // Separable but NOT white-preserving — §11.3.5.2 Note 2. ~keep
    ...
    // existing `pdf_blend_mode_to_skia` fallback semantics. ~keep
    assert_eq!(
...
// HONEST_GAP probe pins this policy. ~keep
