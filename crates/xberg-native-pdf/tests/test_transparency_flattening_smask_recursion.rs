...
pub const HONEST_GAP_SMASK_CYCLIC_G_UNBOUNDED_RECURSION: &str = "HONEST_GAP_SMASK_CYCLIC_G_UNBOUNDED_RECURSION: a Form XObject \
...
fn cyclic_smask_g_centre_pixel_pinned_under_cap() {
    ...
    // earlier or later) shows up as a byte change. ~keep
    assert_eq!(
        (r, g, b, a),
        (255, 85, 85, 255),
