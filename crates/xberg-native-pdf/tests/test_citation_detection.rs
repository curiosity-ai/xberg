...
fn test_detect_numeric_citation_brackets() {
    use xberg_native_pdf::pipeline::text_processing::CitationDetector;
...
fn test_classify_citation_type() {
    use xberg_native_pdf::pipeline::text_processing::{CitationDetector, CitationType};
