//! Semantic guarantees of the auto surface (surfaced by the
//! cross-binding smoke — "runs without error" is not enough; the
...
#[test]
fn auto_native_path_is_faithful_to_canonical_extract_text() {
...
#[test]
fn clean_sparse_text_is_textlayer_not_scanned() {
