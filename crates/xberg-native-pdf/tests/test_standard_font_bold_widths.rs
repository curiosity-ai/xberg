...
fn helvetica_bold_b_is_wider_than_regular() {
    ...
    // Ratio should be approximately 611/556 ≈ 1.099 ~keep
...
fn times_bold_a_is_wider_than_roman() {
    ...
    // Ratio should be approximately 500/444 ≈ 1.126 ~keep
...
fn times_bold_italic_differs_from_bold() {
    ...
    // 'W': Adobe AFM Times-BoldItalic=889, Times-Bold=1000 (BoldItalic is narrower). ~keep
