...
//! CMYK ink. So xberg-native-pdf must undo jpeg-decoder's inversion before the
...
//! through jpeg-decoder returns `param`, and xberg-native-pdf's Adobe inversion then
//! recovers the raw `255 - param` sample plane before applying sec 10.3.5.

use jpeg_encoder::{ColorType, Encoder};
use xberg_native_pdf::extractors::images::{ColorSpace, ImageData, PdfImage};
