...
use crate::crypto::{AesKeySize, Padding, active};
...
fn map_err(e: crate::crypto::Error) -> &'static str {
    ...
    // unknown-future variants get folded to a generic message. ~keep
    match e {
...
mod tests {
    ...
    fn aes128_encrypt_decrypt_round_trip() {
        let key = b"PDF-AES-128-key!";
        let iv = b"AES-IV-16-bytes!";
