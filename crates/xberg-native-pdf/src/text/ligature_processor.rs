...
impl LigatureDecisionMaker {
    ...
    pub fn decide(
        ...
        // Per PDF Spec Section 9.4.4, negative TJ values insert extra space ~keep
        ...
        // Use strict comparison (gap > threshold) to avoid edge cases ~keep
...
///
/// ```
/// use xberg_native_pdf::text::ligature_processor::get_ligature_components;
///
...
///
/// ```
/// use xberg_native_pdf::text::ligature_processor::expand_ligature_to_chars;
///
