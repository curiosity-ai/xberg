...
impl HyphenationHandler {
    ...
    fn is_compound_word(first_part: &str, second_part: &str) -> bool {
        ...
        // Technical compounds (common in RFC/technical documents) ~keep
        ...
        // e.g., "content-coding" vs "Govern-" + "ment" ~keep
            ...
            && first_part.chars().last().is_some_and(|c| c.is_lowercase())
        {
            ...
            // But check if the combined form is a common word ~keep
    ...
    pub fn process_line_pair(&self, current_line: &str, next_line: &str) -> (String, bool) {
        ...
        // Handle both soft hyphen (U+00AD, 2 bytes UTF-8) and hard hyphen (U+002D, 1 byte) ~keep
...
mod tests {
    ...
    fn test_process_line_pair_soft_hyphen() {
        let handler = HyphenationHandler::new();
        // Soft hyphen should ALWAYS join (never a compound word marker) ~keep
    ...
    fn test_process_line_pair_soft_hyphen_always_joins() {
        ...
        // because soft hyphen is ONLY used for optional line breaks ~keep
