    ...
    CACHED_BYTES
        .get_or_init(|| {
            const CANDIDATES: &[&str] = &[
                ...
                // Arabic. Better than `?` for Latin Extended cases. ~keep
