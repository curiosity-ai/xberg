...
impl EncodingNormalizer {
    ...
    ///
    /// ```ignore
    /// use xberg_native_pdf::fonts::{Encoding, encoding_normalizer::EncodingNormalizer};
    ///
    ...
    fn normalize_standard_encoding(&self, char_code: u8, _encoding_name: &str) -> u32 {
        ...
        // encoding for text extraction. Standard encoding tables serve as fallback. ~keep
        char_code as u32
    }
