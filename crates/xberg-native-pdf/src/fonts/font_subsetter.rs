...
///
/// ```ignore
/// use xberg_native_pdf::fonts::{subset_font_bytes, GlyphRemapper};
...
impl SubsetBuilder {
    ...
    pub fn new() -> Self {
        ...
        // Always include glyph 0 (.notdef) per PDF spec ~keep
...
mod tests {
    ...
    /// Regression test: subsetting a CFF/OTF font must not change
