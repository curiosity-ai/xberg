...
impl ExtractionProfile {
    ...
    pub const ACADEMIC: Self = Self {
        ...
        space_threshold_em_ratio: 0.18,
        space_char_multiplier: 0.6,
    ...
    pub const POLICY: Self = Self {
        ...
        space_threshold_em_ratio: 0.22,
        space_char_multiplier: 0.7,
        use_adaptive_threshold: true,
        enable_document_type_detection: false,
        enable_email_detection: false,
        enable_citation_detection: false,
    ...
    pub const SCANNED_OCR: Self = Self {
        name: "Scanned OCR",
        tj_offset_threshold: -85.0,
        word_margin_ratio: 0.2,
        space_threshold_em_ratio: 0.15,
        space_char_multiplier: 0.75,
        use_adaptive_threshold: true,
        enable_document_type_detection: false,
        enable_email_detection: false,
        enable_citation_detection: false,
