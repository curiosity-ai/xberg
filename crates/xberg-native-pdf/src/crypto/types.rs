...
/// listed in the spec but xberg-native-pdf does not currently support it; if
...
/// xberg-native-pdf doesn't currently consume them.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum EcCurve {
...
impl SigningAlgorithm {
    ...
    pub const fn name(self) -> &'static str {
        match (self.asym, self.hash) {
            (AsymmetricAlgorithm::Rsa(RsaScheme::Pkcs1v15), HashAlgorithm::Sha256) => "RSA-PKCS1v15-SHA256",
            (AsymmetricAlgorithm::Rsa(RsaScheme::Pkcs1v15), HashAlgorithm::Sha384) => "RSA-PKCS1v15-SHA384",
            (AsymmetricAlgorithm::Rsa(RsaScheme::Pkcs1v15), HashAlgorithm::Sha512) => "RSA-PKCS1v15-SHA512",
