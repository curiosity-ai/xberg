...
<!-- alef:hash:d5dd0d1a5876d9d336d66534c481a09cc64461e9dcc77d5fe29c672033ddadc8 -->
...
Extract text, tables, images, metadata, and code intelligence from 100 file formats and 371 programming languages including PDF, Office documents, images, and audio/video transcripts where native transcription is available. C/C++ FFI bindings providing a stable ABI for native integration, shared library distribution, and cross-language interop.
