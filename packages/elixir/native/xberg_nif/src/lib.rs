...
// alef:hash:807fabc76663afe07cd3e2dd2b7e267413d3714f9fa79e018e4efa39e6994a10
...
impl From<xberg::ConfidenceSemantics> for ConfidenceSemantics {
    fn from(val: xberg::ConfidenceSemantics) -> Self {
        match val {
            xberg::ConfidenceSemantics::Legibility { scale_max } => Self::Legibility { scale_max: scale_max },
