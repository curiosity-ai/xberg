...
<!-- alef:hash:65eb622b2274533226ed21f206f334d2c434be34d319576c3fef0cb39d6605e7 -->
...
Extract text, tables, images, metadata, and code intelligence from 100 file formats and 371 programming languages including PDF, Office documents, images, and audio/video transcripts where native transcription is available. Zig bindings consuming the C FFI surface via @cImport, idiomatic error sets, optional types, and slice-based memory management.
