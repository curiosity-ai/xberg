...
# alef:hash:ba774057424153edc948fe91694cd2ace39668d393d54fd8123f5d7e737de699
...
defmodule E2e.PluginApiTest do
  ...
  describe "register_embedding_backend_trait_bridge" do
    test "register_embedding_backend_trait_bridge" do
      ...
      _result = Xberg.register_embedding_backend(registerembeddingbackendtraitbridge_pid, "test-embedding-backend")
    end
  end
  ...
  describe "register_ocr_backend_trait_bridge" do
    test "register_ocr_backend_trait_bridge" do
      ...
      _result = Xberg.register_ocr_backend(registerocrbackendtraitbridge_pid, "test-backend")
    end
  end
  ...
  describe "register_post_processor_trait_bridge" do
    test "register_post_processor_trait_bridge" do
      ...
      _result = Xberg.register_post_processor(registerpostprocessortraitbridge_pid, "test-processor")
    end
  end
  ...
  describe "register_reranker_backend_trait_bridge" do
    test "register_reranker_backend_trait_bridge" do
      ...
      _result = Xberg.register_reranker_backend(registerrerankerbackendtraitbridge_pid, "test-reranker-backend")
    end
  end
  ...
  describe "register_tokenizer_backend_trait_bridge" do
    test "register_tokenizer_backend_trait_bridge" do
      ...
      _result = Xberg.register_tokenizer_backend(registertokenizerbackendtraitbridge_pid, "test-tokenizer-backend")
    end
  end
