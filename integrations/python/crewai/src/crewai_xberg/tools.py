...
class XbergExtractTool(BaseTool):
    ...
    Supports 101 file formats including PDF, DOCX, XLSX, HTML, and images with
    ...
    description: str = (
        "Extract text content from a document file or URL. Supports 101 file formats "
...
class XbergExtractBatchTool(BaseTool):
    ...
    description: str = (
        ...
        "faster than extracting them one at a time. Supports 101 file formats and the "
...
class XbergExtractMetadataTool(BaseTool):
    ...
    details as a formatted string. Supports 101 file formats.
    """

    name: str = "Extract Document Metadata"
    description: str = (
        "Extract metadata from a document file such as title, authors, dates, "
        "page count, and format-specific details. Supports 101 file formats "
