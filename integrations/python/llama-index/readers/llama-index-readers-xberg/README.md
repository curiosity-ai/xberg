...
LlamaIndex reader for 101 file formats powered by [xberg](https://github.com/xberg-io/xberg)'s Rust extraction engine.
...
- **101 file formats** -- PDF, DOCX, PPTX, XLSX, HTML, images, emails, archives, and more ([full list](https://docs.xberg.io/reference/formats/))
